<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/pages')) }}" href="{{ route('admin.page.index') }}"><i class="fa fa-file-text"></i>Страницы</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/pages')) }}" href="{{ route('admin.portfolios.index') }}"><i class="fa fa-linode"></i>Портфолио</a>
            </li>
        </ul>
    </nav>
</div><!--sidebar-->