...
use App\Events\Backend\Auth\Role\PortfolioDeleted;
use App\Repositories\Backend\Auth\RoleRepository;
use App\Repositories\Backend\Auth\PermissionRepository;
use App\Http\Requests\Backend\Auth\Role\StoreRoleRequest;
use App\Http\Requests\Backend\Auth\Role\ManageRoleRequest;
use App\Http\Requests\Backend\Auth\Role\UpdatePageRequest;
...
class RoleController extends Controller
{
     ...
     * @return mixed
     */
    public function update(Role $role, UpdatePageRequest $request)
    {
    ...
    public function destroy(Role $role, ManageRoleRequest $request)
    {
        ...
        event(new PortfolioDeleted($role));
